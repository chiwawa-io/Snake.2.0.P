...
{
    public class MissionPreviewWindowHandler : MonoBehaviour
    {
        [SerializeField] private Button _nextButton;

        private Action _onNextButtonClickedCallback;
        public List<MissionPreviewItemView> Items { get; private set; } = new();

        public void ClearMissionPreviewItems() => Items.Clear();

        public void AddMissionPreviewItem(MissionPreviewItemView item) => Items.Add(item);
